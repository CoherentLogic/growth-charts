/*
*  v4wgcmh.js - Growth Charts Adult Men Height
*
...
*  $Revision$
*/
// Growth Chart Adult Men Height
var createMenHeightChart = function(patName, patRec, patDOB, height) {
    ...
    text(91.2*12,228,"Today: " + date);
    text(90.7*12,225,"Chart: Adult Male Height");
